package com.example.alexcosta_rm96022
...
import com.example.alexcosta_rm96022.viewmodel.ItemAdapter
import com.example.alexcosta_rm96022.viewmodel.ItemViewModel
import com.example.alexcosta_rm96022.viewmodel.itemViewModelFactory
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        supportActionBar?.title = "Dicas para Economizar Energia"
        ...
        button.setOnClickListener {
            if (editTextTitulo.text.isEmpty()) {
                editTextTitulo.error = "O titulo não pode estar vazio"
                return@setOnClickListener
            }
            if (editTextDesc.text.isEmpty()) {
                editTextDesc.error = "A descrição não pode estar vazia"
                return@setOnClickListener
            }
